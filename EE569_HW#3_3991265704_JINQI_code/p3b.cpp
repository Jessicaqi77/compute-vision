...
int main(void)
{
    Mat img_11 = imread("/Users/qijin/Desktop/clion/ferrari1.jpg", 1);
    Mat img_21 = imread("/Users/qijin/Desktop/clion/ferrari_2.jpg", 1);
    ...
    if (type == 1)
    {
        ...
        imwrite("/Users/qijin/Desktop/clion/p3b_sift.jpg", imgMatches);
    }
    else
    {
        ...
        Mat imgMatches;
        drawMatches(img_11, keypoints_1, img_21, keypoints_2, Goodmatches, imgMatches, Scalar::all(-1), Scalar::all(-1), std::vector< char >(), DrawMatchesFlags::DEFAULT);
        imwrite("/Users/qijin/Desktop/clion /p3b_surf.jpg", imgMatches);
